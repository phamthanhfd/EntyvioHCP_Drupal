...
$( document ).ready(function() {
    ...
    $("[href^='#']").click(function() {
      ...
      if($('.dosing-content').length || $('[data-page-category="ClinicalEfficacy"]').length){
        if(el_top > scr_top){
          if($(_this).attr("href") == '#isi'){
            console.log('1. window: '+scr_top+', element: '+el_top+', scroll to: '+ el_top + 10);
            $('html, body').animate({
              scrollTop: el_top + 10
            }, 1000);
          }else{
            console.log('2. window: '+scr_top+', element: '+el_top+', scroll to: '+ el_top - 50);
            $('html, body').animate({
                scrollTop: el_top - 50
            }, 1000);
          }
          ...
          if($(_this).attr("href") == '#isi'){
            console.log('3. window: '+scr_top+', element: '+el_top+', scroll to: '+ el_top - 135);
            $('html, body').animate({
              scrollTop: el_top - 135
            }, 1000);
          }else{
            console.log('4. window: '+scr_top+', element: '+el_top+', scroll to: '+ el_top - 165);
            $('html, body').animate({
              scrollTop: el_top - 165
            }, 1000);
          }
        }
      }else{
        if(el_top > scr_top){
          console.log('5. window: '+scr_top+', element: '+el_top+', scroll to: '+ el_top);
          $('html, body').animate({
              scrollTop: el_top
          }, 1000);
        }else{
          console.log('6. window: '+scr_top+', element: '+el_top+', scroll to: '+ el_top - 115);
          $('html, body').animate({
            scrollTop: el_top - 115
          }, 1000);
        }
      }
    });
