...
$( document ).ready(function() {
    ...
    $("#first_section div[data-accordion-type] li").on("click",function(){
      $("#first_section div[data-accordion-type] li.active").find("button").prop("aria-expanded","false");
      $("#first_section div[data-accordion-type] li.active").find("div[aria-hidden]").prop("aria-hidden","true");
