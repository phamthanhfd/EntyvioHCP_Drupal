      ...
      if($('.dosing-content').length || $('[data-page-category="ClinicalEfficacy"]').length){
        if(el_top > scr_top){
          if($(_this).attr("href") == '#isi'){
            _pos = el_top + 10;
            console.log('1. window: '+scr_top+', element: '+el_top+', scroll to: '+ _pos);
          }else{
            _pos = el_top - 50;
            console.log('2. window: '+scr_top+', element: '+el_top+', scroll to: '+ _pos);
          }
        }else{
          if($(_this).attr("href") == '#isi'){
            _pos = el_top - 135;
            console.log('3. window: '+scr_top+', element: '+el_top+', scroll to: '+ _pos);
          }else{
            _pos = el_top - 165;
            console.log('4. window: '+scr_top+', element: '+el_top+', scroll to: '+ _pos);
          }
        }
      }else{
        if(el_top > scr_top){
          _pos = el_top;
          console.log('5. window: '+scr_top+', element: '+el_top+', scroll to: '+ _pos);
        }else{
          _pos = el_top - 115;
          console.log('6. window: '+scr_top+', element: '+el_top+', scroll to: '+ _pos);
        }
      }
      $('html, body').animate({
        scrollTop: _pos
