...
$( document ).ready(function() {
    ...
    $("#first_section div[data-accordion-type] li").on("click",function(){
      $("#first_section div[data-accordion-type] li").removeClass("active");
      $("#first_section div[data-accordion-type] li").find("button").prop("aria-expanded","false");
      $("#first_section div[data-accordion-type] li").find("div[aria-hidden]").prop("aria-hidden","true");

      $(this).addClass("active");
      $(this).find("button").prop("aria-expanded","true");
      $(this).find("div[aria-hidden]").prop("aria-hidden","false");
    })
