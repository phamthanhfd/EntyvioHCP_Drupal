      ...
      <div class=\"container\">
       <div class=\"hcp-text\"><p>For U.S. Healthcare Professionals</p></div>
        ...
        echo "resources/virtual-congress\" target=\"_self\">ANNUAL CONGRESSES</a></li>
                  ...
                  <li class=\"\"><a href=\"";
        // line 76
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["base_path"] ?? null), 76, $this->source), "html", null, true);
        ...
        echo "resources/patient-resources\" target=\"_self\">FOR YOUR PATIENTS</a></h3>
                <ul>
                  ...
                  <li><a href=\"";
        // line 87
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["base_path"] ?? null), 87, $this->source), "html", null, true);
...
<div id=\"fixed_isi\" class=\"active\"></div>
...
";
    ...
    {
        return array (  275 => 139,  265 => 132,  256 => 126,  238 => 113,  227 => 105,  216 => 101,  199 => 87,  192 => 83,  184 => 78,  180 => 77,  176 => 76,  171 => 74,  166 => 72,  157 => 66,  151 => 63,  147 => 62,  143 => 61,  139 => 60,  130 => 54,  120 => 47,  116 => 46,  105 => 38,  96 => 36,  88 => 33,  80 => 30,  54 => 7,  43 => 3,  39 => 1,);
    }
      ...
      <div class=\"container\">
       <div class=\"hcp-text\"><p>For U.S. Healthcare Professionals</p></div>
        ...
        <nav class=\"{% if is_front %} front-page {% endif %}\">
          <!-- NAVIGATION STARTS -->
          <ul>
          <li class=\"active\" homepage=\"{% if is_front %}true{% endif %}\"><a href=\"{{ url('<front>') }}\" title=\"Home\" target=\"_self\">Home</a></li>
          <li class=\"has-submenu clinicalefficacy\">
