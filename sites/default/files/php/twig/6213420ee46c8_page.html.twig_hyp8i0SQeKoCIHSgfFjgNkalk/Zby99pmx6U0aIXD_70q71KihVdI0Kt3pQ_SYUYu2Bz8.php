...
class __TwigTemplate_5b326ba4871be107e5e57822127ba6a9362ba36c083a8c306e9b68440245ae27 extends \Twig\Template
{
    ...
    <div class=\"main-header\">
        ...
        // line 34
        echo "          <button class=\"open-menu\"><span></span></button>
        </div>
    </div>
</header>
<section class=\"main\" id=\"main\">
  ";
        // line 39
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "highlight", [], "any", false, false, true, 39)) {
            // line 40
            echo "  <div class=\"highlight_container\">
    ";
            // line 41
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "highlight", [], "any", false, false, true, 41), 41, $this->source), "html", null, true);
            echo "
  </div>
  ";
        }
  ...
  ";
        // line 45
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "about", [], "any", false, false, true, 45)) {
            // line 46
            echo "  <div class=\"highlight_about\">
    ";
            // line 47
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "about", [], "any", false, false, true, 47), 47, $this->source), "html", null, true);
            echo "
  </div>
  ";
        }
  ...
  ";
        // line 51
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "services", [], "any", false, false, true, 51)) {
            // line 52
            echo "  <div class=\"highlight_services\">
    ";
            // line 53
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "services", [], "any", false, false, true, 53), 53, $this->source), "html", null, true);
            echo "
  </div>
  ";
        }
  ...
  ";
        // line 57
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "content", [], "any", false, false, true, 57)) {
            // line 58
...
<footer aria-label=\"Site footer\" class=\"footer\" id=\"footer\" role=\"contentinfo\">
   <div class=\"footer_container\" >
    ";
        // line 65
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "footer_logo", [], "any", false, false, true, 65)) {
            // line 66
            echo "    <div class=\"footer-logo\">
       <a href=\"http://www.takeda.com/\">";
            // line 67
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "footer_logo", [], "any", false, false, true, 67), 67, $this->source), "html", null, true);
            echo "</a>
    </div>
    ";
        }
    ...
    ";
       ...
       ";
            // line 73
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "footer_menu", [], "any", false, false, true, 73), 73, $this->source), "html", null, true);
            echo "
      </div>
      ";
        }
        // line 76
        echo "      ";
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "footer_content", [], "any", false, false, true, 76)) {
            // line 77
            echo "      <div class=\"footer-detail\">
       ";
            // line 78
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "footer_content", [], "any", false, false, true, 78), 78, $this->source), "html", null, true);
            echo "
       </div>
       ";
        }
...
";
        // line 84
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "sticky_bar", [], "any", false, false, true, 84)) {
            // line 85
            echo "<section class=\"sticky-bar\" style=\"\">
    <div class=\"sticky-bar_container\">
      ";
            // line 87
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "sticky_bar", [], "any", false, false, true, 87), 87, $this->source), "html", null, true);
            echo "
    </div>
</section>
";
...
";
    ...
    {
        return array (  249 => 104,  234 => 91,  227 => 87,  223 => 85,  221 => 84,  216 => 81,  210 => 78,  207 => 77,  204 => 76,  198 => 73,  195 => 72,  193 => 71,  190 => 70,  184 => 67,  181 => 66,  179 => 65,  174 => 62,  168 => 59,  165 => 58,  163 => 57,  160 => 56,  154 => 53,  151 => 52,  149 => 51,  146 => 50,  140 => 47,  137 => 46,  135 => 45,  132 => 44,  126 => 41,  123 => 40,  121 => 39,  114 => 34,  108 => 31,  101 => 30,  98 => 29,  92 => 26,  89 => 25,  87 => 24,  81 => 20,  75 => 17,  72 => 16,  69 => 15,  63 => 12,  60 => 11,  58 => 10,  53 => 7,  47 => 4,  44 => 3,  42 => 2,  39 => 1,);
    }
